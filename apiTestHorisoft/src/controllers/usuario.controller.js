...
async function crearUsuario(req,res){
    ...
    const nuevoUsuario = await Person.create({id_person,number_identification, full_name, full_last_name,birthdate,sex},
...
async function obtenerunusuario (req,res) {
    ...
    const usuarioEncontrado = await Person.findOne({where: {id_person}})
...
async function eliminarusuario (req,res) {
    ...
    res.json({
        mensaje:`The user ${usuarioEliminado} has been deleted`
    })
}
